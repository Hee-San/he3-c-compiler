...
# 関数の呼び出しのみをテストするためのオブジェクトファイルを生成
...
assert 105 'int main() { return (1+(2+3)*4)*5; }'
assert 10 'int main() { return -3*5+25; }'
...
assert 8 'int main() { int foo_123=3; int bar=5; return foo_123+bar; }'

assert 3 'int main() { if (0) return 2; return 3; }'
assert 3 'int main() { if (1-1) return 2; return 3; }'
assert 2 'int main() { if (1) return 2; return 3; }'
assert 2 'int main() { if (2-1) return 2; return 3; }'
assert 5 'int main() { if (0) int a=3; else a=5; return a; }'
assert 3 'int main() { if (1) int a=3; else a=5; return a; }'
assert 7 'int main() { if (0) return 3; else if (0) return 5; else return 7; }'
...
assert 16 'int main() { int x; return sizeof(x); }'
assert 16 'int main() { int x; return sizeof x; }'
assert 16 'int main() { int *x; return sizeof(x); }'
assert 64 'int main() { int x[4]; return sizeof(x); }'
assert 192 'int main() { int x[3][4]; return sizeof(x); }'
assert 64 'int main() { int x[3][4]; return sizeof(*x); }'
